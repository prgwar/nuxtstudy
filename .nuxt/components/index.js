...
export { default as WeatherTemperature } from '../../components/weather/temperature.vue'
export { default as WeatherApp } from '../../components/weather/weatherApp.vue'
export { default as WeatherDisplay } from '../../components/weather/weatherDisplay.vue'
export { default as WeatherWinds } from '../../components/weather/winds.vue'
...
export const LazyWeatherTemperature = import('../../components/weather/temperature.vue' /* webpackChunkName: "components/weather-temperature" */).then(c => c.default || c)
...
export const LazyWeatherDisplay = import('../../components/weather/weatherDisplay.vue' /* webpackChunkName: "components/weather-display" */).then(c => c.default || c)
export const LazyWeatherWinds = import('../../components/weather/winds.vue' /* webpackChunkName: "components/weather-winds" */).then(c => c.default || c)
